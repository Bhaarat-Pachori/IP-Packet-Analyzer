...
public class ip {
	public String ReadIPHeader(StringBuilder hexData, int data_size) {
		...
		for(int which_field=0;which_field<IHL*2;which_field++) {
			...
			if(which_field == 0) {
				...
				for(int bits_in_byte=0;bits_in_byte<4;bits_in_byte++) {
					...
					if(bits_in_byte == 3) {
						System.out.println("IP:   Version = "+ver_val);
						pktanalyzer.reset_parsing_buffer(parsing_header);
					}
				}
			}
			...
			if(which_field == 3) {
				...
				for(int bits_in_byte=0;bits_in_byte<6;bits_in_byte++) {
					...
					if(bits_in_byte == 1) {
						 ...
						 */
						ver_val = ver_val / 4;
						System.out.println("IP:   DSCP (6 bits) = "+"0x"+Integer.toHexString(ver_val));
						switch(ver_val) {
						case 0: System.out.println("IP:   000000.. = "+"Best effort");
								break;
						case 46: System.out.println("IP:  101110.. = "+"Expedited forwarding (EF)");
								break;
						case 10: System.out.println("IP:  001010.. = "+"AF11");
								break;
						case 12: System.out.println("IP:  001100.. = "+"AF12");
								break;
						case 14: System.out.println("IP:  001110.. = "+"AF13");
								break;
						case 18: System.out.println("IP:  010010.. = "+"AF21");
								break;
						case 20: System.out.println("IP:  010100.. = "+"AF22");
								break;
						case 22: System.out.println("IP:  010110.. = "+"AF23");
								break;
						case 26: System.out.println("IP:  011010.. = "+"AF31");
								break;
						case 28: System.out.println("IP:  011100.. = "+"AF32");
								break;
						case 30: System.out.println("IP:  011110.. = "+"AF33");
								break;
						case 34: System.out.println("IP:  100010.. = "+"AF41");
								break;
						case 36: System.out.println("IP:  100100.. = "+"AF42");
								break;
						case 38: System.out.println("IP:  100110.. = "+"AF43");
								break;
						}
					}
				}
			...
			if(which_field == 3) {
				...
				for(int bits_in_byte=0;bits_in_byte<2;bits_in_byte++) {
					ver_bit_shifter = ver_bit_shifter << 1;
					if(bits_in_byte == 1) {
						System.out.println("IP:   ECN (2 bits) = "+"0x"+parsing_header.toString());
						switch(val) {
						case 0: System.out.println("IP:   ......00 = "+"Non ECT");
								break;
						case 1: System.out.println("IP:   ......01 = "+"ECT(1)");
								break;
						case 2: System.out.println("IP:   ......10 = "+"ECT(0)");
								break;
						case 3: System.out.println("IP:   ......11 = "+"Congestion Encountered");
								break;
						}
						pktanalyzer.reset_parsing_buffer(parsing_header);
					}
			...
			if(which_field == (BYTE*4) -1) {
				...
				int val = Integer.parseInt(parsing_header.toString(), 16);
				System.out.println("IP:   Total length = "+val+" bytes");
				//pktanalyzer.reset_parsing_buffer(parsing_header);
				pktanalyzer.reset_parsing_buffer(parsing_header);
			}
			...
			if(which_field == (BYTE*6)-1) {
				int val = Integer.parseInt(parsing_header.toString(), 16);
				System.out.println("IP:   Identification = "+"0x"+parsing_header.toString()+ " ("+val+")");
				pktanalyzer.reset_parsing_buffer(parsing_header);
			...
			if(which_field == BYTE*8) {
				...
				System.out.println("IP:   Flags = "+"0x"+(org_val_to_represent / 8192));
				bit_test = 16384;
				if((bit_test & val) == 16384) {
					System.out.println("IP:   \t.1..  = "+"Don't fragment");
				}
				else {
					System.out.println("IP:   \t.0..  = "+"Fragment packet");
				}
				bit_test = bit_test>>1;
				if((bit_test & val) == 8192) {
					System.out.println("IP:   \t..1.  = "+"fragment packets following");
				}
				else {
			...
			if(which_field == (BYTE*8)) {
				...
				System.out.println("IP:   Fragment offset = "+total_val + " bytes");
				pktanalyzer.reset_parsing_buffer(parsing_header);
			}
			...
			if(which_field == (BYTE*8)+1) {
				int val = Integer.parseInt(parsing_header.toString(), 16);
				System.out.println("IP:   Time to live = "+val+" seconds/hops");
				pktanalyzer.reset_parsing_buffer(parsing_header);
			}
			...
			if(which_field == (BYTE*9) + 1) {
				...
				if(val == 6)
					next_header = "TCP";
				System.out.println("IP:   Protocol = "+val+" ("+next_header+")");
				pktanalyzer.reset_parsing_buffer(parsing_header);
			}
			...
			if(which_field == (BYTE*12) - 1) {
				System.out.println("IP:   Header checksum = "+"0x"+parsing_header.toString());
				pktanalyzer.reset_parsing_buffer(parsing_header);
			}
			...
			if(which_field == (BYTE*16) - 1) {
				...
				System.out.println("IP:   Source address = "+ip_address);
				pktanalyzer.reset_parsing_buffer(parsing_header);
			...
			if(which_field == (BYTE*20) - 1) {
				ip_address.setCharAt(ip_address.length()-1, ' ');
				System.out.println("IP:   Destination address = "+ip_address);
				pktanalyzer.reset_parsing_buffer(parsing_header);
				ip_address.setLength(0);
				if(IHL*2 == 40) {
					System.out.println("IP:   "+no_options);
