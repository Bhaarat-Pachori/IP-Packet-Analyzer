...
public class icmp {
	...
	public String ReadICMPHeader(StringBuilder hexData, int data_size) {
	...
	for(int which_field=0;which_field<ICMPHeader.length();which_field++) {
		...
		if(which_field == TYPE_START+1) {
			...
			switch(val) {
			case 0:	System.out.println("ICMP:  Type = "+val+" Echo Reply");
				break;
			case 3: System.out.println("ICMP:  Type = "+val+" Destination Unreachable");
				break;
			case 4: System.out.println("ICMP:  Type = "+val+" Source Quench");
				break;
			case 5: System.out.println("ICMP:  Type = "+val+" Redirect Message");
				break;
			case 8: System.out.println("ICMP:  Type = "+val+" Echo Request");
				break;
			case 9: System.out.println("ICMP:  Type = "+val+" Router Advertisement");
				break;
			case 10: System.out.println("ICMP:  Type = "+val+" Router Solicitationt");
				break;
			case 11: System.out.println("ICMP:  Type = "+val+" Time Exceeded");
				break;
			case 12: System.out.println("ICMP:  Type = "+val+" Bad IP header");
				break;
			case 13: System.out.println("ICMP:  Type = "+val+" Timestamp");
				break;
			case 14: System.out.println("ICMP:  Type = "+val+" Timestamp Reply");
				break;
			}
		...
		if(which_field == AFTER_CHKSUM - 1) {
			System.out.println("ICMP:  Checksum = "+"0x"+parsing_header.toString());
			System.out.println("ICMP:");
		}
	}
	return null;
